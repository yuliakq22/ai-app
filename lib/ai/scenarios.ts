...
export const assertivenessScenarios: Scenario[] = [
  ...
  },
  {
    ...
    context: 'Your partner interrupts and uses sarcasm when conversations become tense.',
  ...
  },
  {
    ...
    context: 'Your food arrives with an ingredient you clearly asked to remove.',
  ...
  },
  {
    ...
    context: 'You received an offer that is exciting, but the salary is below your target range.',
  ...
  },
  {
    ...
    context: 'A family member implies you are selfish for not agreeing to their request.',
